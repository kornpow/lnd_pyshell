...
# ****** FEE INFO ******
def updateChanPolicy(chan_point=None,fee_rate=0.000001,base_fee_msat=300,tld=40,min_htlc=1):
	url = '/v1/chanpolicy'
	data = {
		'time_lock_delta': tld,
	...
	if chan_point == None:
		...
		data.update({'chan_point' : {
			'funding_txid_bytes': base64.b64encode(bytes.fromhex(cp)).decode(),
